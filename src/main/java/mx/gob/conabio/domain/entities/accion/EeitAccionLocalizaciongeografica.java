 ...
 */
@Entity
@Table(name = "eeit_accion_localizacion_geografica", catalog = "conabio", schema = "")
@NamedQueries({
    @NamedQuery(name = "EeitAccionLocalizaciongeografica.findAll", query = "SELECT e FROM EeitAccionLocalizaciongeografica e")})
public class EeitAccionLocalizaciongeografica implements Serializable {
    ...
    public EeitAccionLocalizaciongeografica() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EeitAccionLocalizaciongeografica)) {
            return false;
        }
        EeitAccionLocalizaciongeografica other = (EeitAccionLocalizaciongeografica) object;
    ...
    public String toString() {
        return "mx.gob.conabio.domain.entities.EeitLocalizaciongeografica[ idAccion =" + idAccion + " ]";
    }
