 ...
 */
@Entity
@Table(name = "eeit_actividad_info_financiera_detalle", catalog = "conabio", schema = "")
@NamedQueries({
    @NamedQuery(name = "EeitActividadInfoFinancieraDetalle.findAll", query = "SELECT e FROM EeitActividadInfoFinancieraDetalle e")
    , @NamedQuery(name = "EeitActividadInfoFinancieraDetalle.findByIdActividad", query = "SELECT e FROM EeitActividadInfoFinancieraDetalle e WHERE e.eeitActividadInfoFinancieraDetallePK.idActividad = :idActividad")
    , @NamedQuery(name = "EeitActividadInfoFinancieraDetalle.findByAnio", query = "SELECT e FROM EeitActividadInfoFinancieraDetalle e WHERE e.eeitActividadInfoFinancieraDetallePK.anio = :anio")})
public class EeitActividadInfoFinancieraDetalle implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected EeitActividadInfoFinancieraDetallePK eeitActividadInfoFinancieraDetallePK;
    @Size(max = 100)
    ...
    public EeitActividadInfoFinancieraDetalle() {
    }

    public EeitActividadInfoFinancieraDetalle(EeitActividadInfoFinancieraDetallePK eeitActividadInfoFinancieraDetallePK) {
        this.eeitActividadInfoFinancieraDetallePK = eeitActividadInfoFinancieraDetallePK;
    }

    public EeitActividadInfoFinancieraDetalle(int idActividad, int anio) {
        this.eeitActividadInfoFinancieraDetallePK = new EeitActividadInfoFinancieraDetallePK(idActividad, anio);
    }

    public EeitActividadInfoFinancieraDetallePK getEeitActividadInfoFinancieraDetallePK() {
        return eeitActividadInfoFinancieraDetallePK;
    }

    public void setEeitActividadInfoFinancieraDetallePK(EeitActividadInfoFinancieraDetallePK eeitActividadInfoFinancieraDetallePK) {
        this.eeitActividadInfoFinancieraDetallePK = eeitActividadInfoFinancieraDetallePK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (eeitActividadInfoFinancieraDetallePK != null ? eeitActividadInfoFinancieraDetallePK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EeitActividadInfoFinancieraDetalle)) {
            return false;
        }
        EeitActividadInfoFinancieraDetalle other = (EeitActividadInfoFinancieraDetalle) object;
        if ((this.eeitActividadInfoFinancieraDetallePK == null && other.eeitActividadInfoFinancieraDetallePK != null) || (this.eeitActividadInfoFinancieraDetallePK != null && !this.eeitActividadInfoFinancieraDetallePK.equals(other.eeitActividadInfoFinancieraDetallePK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "mx.gob.conabio.domain.entities.actividad.finanzas.EeitActividadInfoFinancieraDetalle[ eeitActividadInfoFinancieraDetallePK=" + eeitActividadInfoFinancieraDetallePK + " ]";
    }
