...
import mx.gob.conabio.domain.entities.EeicEstatususuario;
...
@NamedQueries({
    @NamedQuery(name = "EeipUsuariosConsulta.findByNombreUsuario", query = "SELECT e FROM EeipUsuarios e WHERE e.nombreUsuario = :nombreUsuario"),
    @NamedQuery(name = "EeipUsuariosConsulta.findByEmail", query = "SELECT e FROM EeipUsuarios e WHERE e.email = :mail"),
    @NamedQuery(name = "EeipUsuariosConsulta.findByIdRol", query = "SELECT e FROM EeipUsuarios e WHERE e.idRol.idRol = :idRol")
    })

public class EeipUsuariosConsulta implements Serializable, UserDetails {
    ...
    @JoinColumn(name = "idEstatusUsuario", referencedColumnName = "idEstatusUsuario")
    @OneToOne
    private @Getter @Setter EeicEstatususuario idEstatusUsuario;
    ...
    @Transient
    private @Getter @Setter String descRol;
    
    public EeipUsuariosConsulta() {
    }

    public EeipUsuariosConsulta(Integer idUsuario) {
        this.idUsuario = idUsuario;
    }

    public EeipUsuariosConsulta(Integer idUsuario, int idEstatusUsuario, int idTipoInstitucion, int idInstitucion, String nombre, String telefono, String email, boolean perteneceGEF, boolean infoPublica, Date fechaRegistro, String password) {
        this.idUsuario = idUsuario;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EeipUsuariosConsulta)) {
            return false;
        }
        EeipUsuariosConsulta other = (EeipUsuariosConsulta) object;
